...
int main() {
	...
	/*if (setsockopt(sockUDP, SOL_SOCKET, SO_BROADCAST, &AllowBroadcast, sizeof(AllowBroadcast))) {
	...
	/*sAddrUDP.sin_addr.S_un.S_addr = INADDR_BROADCAST;
	sAddrUDP.sin_family = AF_INET;
	sAddrUDP.sin_port = htons(101010);*/
